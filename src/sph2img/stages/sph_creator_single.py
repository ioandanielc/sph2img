...
def prepare_sph_interpolator(iteration_number: int,
    ...
    try:
        ...
        raise RuntimeError(
            f"Missing expected phase in outputs: {e}."
        ) from e

    logger.info("Refactored until here, but not tested")
